...
from mimic_cxr_jpg_loader.filters import Modifier

class MIMIC_Dataset():
    def __init__(self, root: str, split_path: str, modifier: List[Modifier] = []):
        self.root = Path(root)
    ...
    def get_labels(self) -> pd.DataFrame:
        ...
        labels = metadata_labels.merge(chexpert_labels, on="study_id", how="left").dropna(subset=["subject_id"])
        labels = labels.merge(
